...
import 'package:oak_dart_openfeign/src/executor/default_feign_client_executor.dart';
...
class DefaultFeignClientExecutorFactory implements FeignClientExecutorFactory {
  static final Map<Type, FeignClientExecutor> _FEIGN_CLIENT_EXECUTOR_CACHE = {};
  ...
  FeignClientExecutor factory(TypeMirror typedefMirror, Type clientType, FeignConfiguration configuration) {
    ...
    if (executor == null) {
      executor = new DefaultFeignClientExecutor(typedefMirror as ClassMirror, clientType, configuration);
