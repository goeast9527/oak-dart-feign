...
abstract class AddArticleActionReq
    implements Built<AddArticleActionReq, AddArticleActionReqBuilder>, JsonSerializableObject {
  ...
  Map<String, dynamic> toMap() {
    return serializers.serializeWith(AddArticleActionReq.serializer, this) as Map<String, dynamic>;
  }
  ...
  static AddArticleActionReq formJson(String json) {
    return serializers.deserializeWith(AddArticleActionReq.serializer, jsonDecode(json)) as AddArticleActionReq;
  }
}
