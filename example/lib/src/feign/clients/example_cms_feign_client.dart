...
class ExampleCmsFeignClient extends FeignProxyClient {
  ...
  Future<BuiltList<int>> getNums(int num, [UIOptions? feignOptions]) {
    return this.delegateInvoke<BuiltList<int>>(
        "getNums",
        [
          num,
        ],
        feignOptions: feignOptions,
        serializer: BuiltValueSerializable(specifiedType: FullType(BuiltList, [FullType(int)])));
  }
  ...
  Future<BuiltList<BuiltMap<int, String>>> getMaps(int num, [UIOptions? feignOptions]) {
    return this.delegateInvoke<BuiltList<BuiltMap<int, String>>>(
        "getMaps",
        [
          num,
        ],
  ...
  Future<BuiltMap<String, int>> getMap([UIOptions? feignOptions]) {
    return this.delegateInvoke<BuiltMap<String, int>>("getMap", [],
        feignOptions: feignOptions,
        serializer: BuiltValueSerializable(specifiedType: FullType(BuiltMap, [FullType(String), FullType(int)])));
  }
  ...
  Future<BuiltMap<String, BuiltList<bool>>> getMap2([UIOptions? feignOptions]) {
