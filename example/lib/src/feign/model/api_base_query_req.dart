...
abstract class ApiBaseQueryReq implements Built<ApiBaseQueryReq, ApiBaseQueryReqBuilder>, JsonSerializableObject {
  ...
  Map<String, dynamic> toMap() {
    return serializers.serializeWith(ApiBaseQueryReq.serializer, this) as Map<String, dynamic>;
  }
  ...
  static ApiBaseQueryReq formJson(String json) {
    return serializers.deserializeWith(ApiBaseQueryReq.serializer, jsonDecode(json)) as ApiBaseQueryReq;
  }
}
